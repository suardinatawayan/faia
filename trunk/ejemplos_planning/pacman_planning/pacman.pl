...
obtenerAccion(Accion) :-
	solve([vacio(1),vacio(2),vacio(3),vacio(4),
		   vacio(5),vacio(6),vacio(7),vacio(8),
		   vacio(9),vacio(10),vacio(11),vacio(12),
		   vacio(13),vacio(14),vacio(15),vacio(16)],P,10),
	seq(P,[Init,Accion|S]),!.
